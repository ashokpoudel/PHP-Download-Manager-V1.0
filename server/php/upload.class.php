...
class UploadHandler
{
    ...
    public function post() {
        ...
        mysql_selectdb('dlmanager');
        mysql_query("INSERT INTO files (filename, time) VALUES ('".$upload['name'][0]."', '".date('Y-m-d')."')");
        mysql_close($con);
        }
    ...
    public function delete() {
        ...
        echo json_encode($success);
                    ...
                    $con = mysql_connect('localhost','root','');
                    mysql_selectdb('dlmanager');
                    mysql_query("DELETE FROM files WHERE filename='".$file_name."'");
                    mysql_close($con);
    }
